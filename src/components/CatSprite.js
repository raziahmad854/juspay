...
export default function CatSprite({ sprite, isSelected, onClick }) {
  return (
    <div
      onClick={onClick}
    ...
    >
      ...
      {sprite.message && (
        <div
          className={`absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 px-3 py-2 rounded-lg text-sm whitespace-nowrap ${
            sprite.messageType === "think"
      ...
      >
        ...
        {/* Sprite Name Label */}
        <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-xs font-semibold whitespace-nowrap bg-white px-2 py-1 rounded shadow">
          {sprite.name}
        </div>
      </div>
    </div>
